...
<template>
    ...
    <Head>
        <Title>{{ route.query.query ? route.query.query : "Search Page" }} - Clothing Store Search</Title>
        <Meta name="description" content="{{ route.query.query ? route.query.query : 'Search Page' }}" />
    </Head>
    <div class="page-container">
        ...
        <main>
            <div class="search-control">
                ...
                <h2>{{ route.query.query ? `You Searched for: ${route.query.query}` : "" }} </h2>
                <div class="select">
            ...
            <div class="products-container">
                <ul class="products">
                    <Product v-for="product in products" :key="product.id" :title="product.name" :oldPrice="product.oldPrice" :newPrice="product.newPrice" :images="product.images" :sku="product.sku" />
                </ul>
            </div>
        </main>
    </div>
